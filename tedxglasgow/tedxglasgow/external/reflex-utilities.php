<?php
	 ...
	 * The main one that is used in Reflex is Reflex_Utilities::add_slug_to_body_class(), this will add the page or post slug to the body class
	 *
	 */
	 
	 class Reflex_Utilities {
    	 ...
    	 * e.g. Reflex_Utilities::get_page_id_from_path('about/terms-and-conditions');
    	 *
    	 * @param 	string 
    	 * @return 	integer
    	 * @author 	Keir Whitaker
